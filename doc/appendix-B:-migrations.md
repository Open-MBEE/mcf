# Migrations
Whenever a significant change in the database structure occurs, a migration script 
is released that updates the data stored in the database to the new format.
...
This means all existing users will have to be deleted and recreated.
